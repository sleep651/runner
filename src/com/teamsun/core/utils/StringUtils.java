...
public class StringUtils {
    ...
    public static String getUtf2GBK(String source) {
    	try {
    ...
    public static String getGB2312ToGBK(String source) {
    	//java.net.URLEncoder.encode(source,"gb2312");
    	try {
...
//        return filePath;
	...
	public static String map2SqlStr(Map valueMap){
        ...
        for (Iterator it = setEntriy.iterator(); it.hasNext();) { 
            ...
            if((!isEmpty(key.toString()))&&(!isObjEmpty(value))){
