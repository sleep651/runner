...
public class MD5 {
	...
	/*public static void main(String args[]) {
		...
		if (Array.getLength(args) == 0) {
			logger.debug("MD5 Test suite:");
			logger.debug("MD5(\"\"):".concat(String.valueOf(String
					.valueOf(m.getMD5ofStr("")))));
			logger.debug("MD5(\"a\"):".concat(String.valueOf(String
					.valueOf(m.getMD5ofStr("a")))));
			logger.debug("MD5(\"abc\"):".concat(String.valueOf(String
					.valueOf(m.getMD5ofStr("abc")))));
			logger.debug("MD5(\"message digest\"):".concat(String
					.valueOf(String.valueOf(m.getMD5ofStr("message digest")))));
			logger.debug("MD5(\"abcdefghijklmnopqrstuvwxyz\"):"
